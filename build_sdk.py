...
def main() -> None:
    ...
    parser.add_argument("--only-board", metavar="BOARD", help="Only artifacts for BOARD will be built")
    parser.add_argument("--only-config", metavar="CONFIG", choices=["debug", "release"], help="Only artifacts for CONFIG will be built")
